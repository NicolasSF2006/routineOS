...
import { CalendarDays, ChevronLeft, ChevronRight, ListChecks, Settings2, ShieldCheck, Sparkles } from "lucide-react"
...
export function OnboardingDialog({ open, onComplete }: OnboardingDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/35 p-4 backdrop-blur-sm">
      <section
        className="flex max-h-[calc(100svh-2rem)] w-full max-w-2xl flex-col overflow-hidden rounded-3xl border border-border bg-background shadow-2xl"
        role="dialog"
        aria-modal="true"
      ...
      >
        <div className="flex items-center justify-between gap-4 border-b border-border px-5 py-4 sm:px-6">
          ...
          <Button type="button" variant="ghost" className="shrink-0" onClick={onComplete}>
            Pular tutorial
          </Button>
        </div>
        ...
        <div className="min-h-0 overflow-y-auto px-5 py-6 sm:px-8 sm:py-8">
          <div className="mx-auto flex max-w-xl flex-col items-center text-center">
            <div className="mb-5 flex size-16 items-center justify-center rounded-2xl bg-primary/10 text-primary sm:size-20">
            ...
            <p id="onboarding-description" className="mt-3 wrap-break-word text-base leading-7 text-muted-foreground">
