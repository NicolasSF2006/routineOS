...
export const MENTOR_SYSTEM_PROMPT = [
  ...
  "Use as marcações da trilha como contexto real de aprendizagem: recursos favoritos indicam prioridade, recursos estudados indicam o que o usuário já viu e já praticou, e recursos ocultados não devem ser recomendados novamente.",
